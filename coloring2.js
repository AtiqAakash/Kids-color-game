...
var drawingApp = (function() {
    ...
    var contexts = {},
        ...
        canvasHeight = bHeight - (bHeight * 0.3),
...
console.log("here"+drawingAreaWidth);
        ...
        init = function(width, height) {
            ...
            canvasDiv.style.height = Math.round(bHeight*0.65) + "px";
            canvasDiv.style.width = Math.round(bWidth * 0.5) + "px";
